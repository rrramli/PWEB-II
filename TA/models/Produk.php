...
class Produk
{
    ...
    {
        $query = "INSERT INTO produk (sup_id, nm_brg, kategori, kedaluwarsa, harga)
                  VALUES('$sup_id', '$nm_brg', '$kategori', '$kedaluwarsa', '$harga')";
    ...
    {
        $query = "UPDATE produk set nm_brg='$nm_brg', kategori='$kategori', kedaluwarsa='$kedaluwarsa', harga='$harga' where kd='$kd'";
        $result = mysqli_query($this->koneksi, $query);
