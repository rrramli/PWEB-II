...
<body>
  ...
  <main id="main" class="main">
    ...
    <section>
      ...
      <div class="card">
        <div class="card-body">
          <a class="btn btn-primary mb-3 mt-3" href="tambah.php">Tambah Produk</a><br>
          <table class="table table-striped mb-2">
            ...
            foreach ($produk as $x) {
              ...
              <tr>
                ...
                <td align="center">
                  <a class="btn btn-warning bi-pencil" title="Edit Data Produk"
                    href="edit.php?kd=<?php echo $x['kd']; ?>"></a>
                  <a class="btn btn-danger bi-trash" title="Hapus Data Produk" href="hapus.php?kd=<?php echo $x['kd']; ?>"
