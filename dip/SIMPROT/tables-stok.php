    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="tables-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="tables-stok.php" class="active">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
        ...
        <section>
          ...
          <div class="card">
            <div class="card-body">
              <table class="table table-striped mb-2 mt-4">
                  <tr align="center">
                      <th>No</th>
                      <th>ID Suplier</th>
                      <th>Nama Barang</th>
                  ...
                  foreach ($produk as $x) {
                      ...
                      <tr>
                          ...
                          <td align="center"><?php echo $x['sup_id'] ?></td>
                          <td><?php echo $x['nm_brg'] ?></td>
                          <td><?php echo $x['kategori'] ?></td>
                          <td align="center"><?php echo $x['kedaluwarsa'] ?></td>
