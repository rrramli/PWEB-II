...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="card">
            <div class="card-body">
                <a class="btn btn-primary mb-2 mt-4" href="suplier/tambah.php">Tambah Data Suplier</a><br>
                ...
                <table class="table table-striped mb-2 mt-2">
                    ...
                    foreach ($suplier as $x) {
                        ...
                        <tr>
                            ...
                            <td align="center">
                                <a class="btn btn-warning bi-pencil" title="Edit Data Suplier"
                                    href="suplier/edit.php?sup_id=<?php echo $x['sup_id']; ?>"></a>
                                <a class="btn btn-danger bi-trash" title="Hapus Data Suplier"
                                    href="suplier/hapus.php?sup_id=<?php echo $x['sup_id']; ?>"
                                    onclick="return confirm('Apakah anda yakin ingin menghapus data?')"></a>
                            </td>
                        </tr>
                        <?php
                    }
